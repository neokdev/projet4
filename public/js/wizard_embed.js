...
let $addticketLink = $('<a role="button" href="#" class="add_ticket_link btn btn-primary">Add a ticket</a>');
...
function addticketForm($collectionHolder, $newLinkLi) {
    ...
    $newFormLi.append('<a role="button" href="#" class="remove-ticket btn btn-danger">Remove this ticket</a>');
